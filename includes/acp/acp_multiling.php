...
class acp_multiling
{
    ...
    function main($id, $mode)
    {
        ...
        switch($mode)
        {
            ...
            if ($submit)
            {
                $multiling_delimiter = utf8_normalize_nfc(request_var('multiling_delimiter', '', true));
                $multiling_languages = utf8_normalize_nfc(request_var('multiling_languages', '', true));
